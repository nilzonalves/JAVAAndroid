...
public class Principal extends AppCompatActivity {
    ...
    protected void onRestoreInstanceState(Bundle savedInstanceState){
        ...
        controle = savedInstanceState.getBoolean("controle");
        if(controle == false){
    ...
    public void onSaveInstanceState(Bundle savedInstanceState) {
        ...
        savedInstanceState.putBoolean("controle", controle);
        // etc.// etc.
    }
    ...
    public void click(View v){
        try {
            ...
            edtQtdStr = "" + edtQtd.getText().toString();
            if(octUmStr.equals("0")||Integer.parseInt(octUmStr)> 255 ||Integer.parseInt(octDoisStr)> 255||Integer.parseInt(octTresStr)> 255||Integer.parseInt(octQuatroStr)> 254||Integer.parseInt(edtQtdStr)> 16777216||edtQtdStr.equals("0")){
